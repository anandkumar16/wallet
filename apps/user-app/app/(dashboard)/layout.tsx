    ...
    <div className="flex">
        <div className="w-72 border-r border-slate-300 min-h-screen mr-4 pt-28">
            <div>
                ...
                <SidebarItem href={"/transactions"} icon={<TransactionsIcon />} title="Transactions History" />
                <SidebarItem href={"/p2p"} icon={<P2PTransferIcon />} title="Transfer to" />
                <SidebarItem href={"/checkbalance"} icon={<Checkbalance/>} title="Check Balance" />
            </div>
        </div>
            {children}
    </div>
